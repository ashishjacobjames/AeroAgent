...
export const Card = ({
  ...
  <div
    onClick={onClick}
    className={cn(
      'bg-[#111827] rounded-xl border border-gray-800 shadow-xl overflow-hidden transition-all duration-200 hover:border-gray-700',
      !noPadding && 'p-4',
...
export const Badge = ({
  ...
  const variants = {
    ...
    slate: 'bg-gray-500/20 text-gray-400 border-gray-500/30',
    teal: 'bg-emerald-500/20 text-emerald-400 border-emerald-500/30',
...
export const Tooltip = ({
  ...
  return (
    <div className="group relative inline-block">
      {children}
      <div className="absolute z-50 invisible group-hover:visible bg-[#1F2937] text-gray-200 text-[11px] rounded-lg p-3 shadow-xl -bottom-2 translate-y-full left-1/2 -translate-x-1/2 min-w-[240px] border border-gray-700 backdrop-blur-md transition-all duration-200">
        {content}
        <div className="absolute -top-1 left-1/2 -translate-x-1/2 border-4 border-transparent border-b-[#1F2937]" />
      </div>
    </div>
  );
};
...
export const KPICard = ({
  ...
  >
    <div
      className={cn(
        'rounded-lg flex items-center justify-center text-white shrink-0 transition-transform duration-200 group-hover:scale-105',
        color,
    ...
    <div className="min-w-0 flex-1">
      <p
        className={cn(
          'font-bold text-gray-400 uppercase tracking-widest mb-0.5 font-sans truncate',
      ...
      <p
        className={cn(
          'font-bold text-white truncate font-sans tabular-nums tracking-tight leading-none mb-1',
    ...
    <div className="space-y-1.5" ref={containerRef}>
      ...
      <div className="relative">
        ...
        >
          ...
          <input
            type="text"
            className="flex-1 bg-transparent border-none focus:ring-0 text-sm p-0 min-w-[100px] placeholder:text-slate-400"
            placeholder={
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed bottom-6 right-6 z-[9999] bg-slate-900 text-white px-5 py-3 rounded-xl shadow-2xl flex items-center gap-3 border border-white/10 backdrop-blur-md"
        >
